...
test_json_endpoint "GET" "$BASE_URL/straatnamen/https%3A%2F%2Fn2t.net%2Fark%3A%2F60537%2Fb4N7Fm" 200 "Geef informatie over het Houtmanspad (https://n2t.net/ark:/60537/b4N7Fm); valideer dat problematisch-uitleg na een newline in genoemd_naar zit en sinds null is" "application/json" '.identifier and .naam and (.problematisch | type == "string") and (.problematisch | length > 0) and .genoemd_naar == ("Genoemd naar zie Houtmansgracht.\n" + .problematisch) and .sinds == null'
